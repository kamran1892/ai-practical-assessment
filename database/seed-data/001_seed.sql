-- Seed data for Support Ticket Management System (Core)
-- Run AFTER 001_schema.sql
-- Source of truth: database/seed-data/
-- Mirror copy: project/db/001_seed.sql
...
-- At least 3 users (ids fixed for predictable ticket/comment FKs)
...
-- Tickets in different statuses (and one unassigned Open)
